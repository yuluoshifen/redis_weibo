...
<h2 class="username"><?php echo $profile_username; ?></h2>
<a href="follow.php?uid=<?php echo $profile_userid; ?>&f=<?php echo $isFollowingStatus; ?>"
   class="button"><?php echo $isFollowingText; ?></a>
